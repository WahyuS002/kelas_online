...
<div class="row">
    ...
    <div class="col-7 card-margin ml-5">
        ...
        <livewire:admin.kelas-review :kelas="$kelas">
    </div>
</div>
...
@push('script-after')
<script>
    window.addEventListener('closeSetujuModal', event => {
        $('#modalFormSetuju').modal('hide');
    })

    window.addEventListener('openSetujuModal', event => {
        $('#modalFormSetuju').modal('show');
    })

    window.addEventListener('closeTolakModal', event => {
        $('#modalFormTolak').modal('hide');
    })

    window.addEventListener('openTolakModal', event => {
        $('#modalFormTolak').modal('show');
    })
