...
<link href="{{ asset('cursus/css/vertical-responsive-menu1.min.css') }}" rel="stylesheet">
<link href="{{ asset('cursus/css/instructor-dashboard.css') }}" rel="stylesheet">
<link href="{{ asset('cursus/css/instructor-responsive.css') }}" rel="stylesheet">
