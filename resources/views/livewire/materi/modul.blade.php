    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row d-flex align-items-center">
                ...
                <a href="{{ route('materi.show', ["slug_kelas" => $slug_kelas, 'slug_materi' => $m->slug_materi ,"urutan" => $m->urutan]) }}" class="col-8 text-primary">
                    @if ($m->progress(auth()->user()->id ,$slug_kelas, $m->id))
