...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('cork-frontend/assets/img/favicon.ico') }}"/>
    <link href="{{ asset('cork-frontend/assets/css/loader.css') }}" rel="stylesheet" type="text/css" />
    <script src="{{ asset('cork-frontend/assets/js/loader.js') }}"></script>

    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Quicksand:400,500,600,700&display=swap" rel="stylesheet">
    <link href="{{ asset('cork/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('cork-frontend/assets/css/plugins.css') }}" rel="stylesheet" type="text/css" />
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="index.html"><img alt="logo" src="{{ asset('cork-frontend/assets/img/90x90.jpg') }}"> <span class="navbar-brand-name">CORK</span></a>
            </div>
            ...
            <ul class="navbar-item flex-row nav-dropdowns">
                ...
                <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            <img src="{{ asset('cork-frontend/assets/img/90x90.jpg') }}" class="img-fluid" alt="admin-profile">
    ...
    <script src="{{ asset('cork-frontend/assets/js/libs/jquery-3.1.1.min.js') }}"></script>
    <script src="{{ asset('cork-frontend/bootstrap/js/popper.min.js') }}"></script>
    <script src="{{ asset('cork-frontend/bootstrap/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('cork-frontend/plugins/perfect-scrollbar/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ asset('cork-frontend/assets/js/app.js') }}"></script>
    <script>
        $(document).ready(function() {
            App.init();
        });
    </script>
    <script src="{{ asset('cork-frontend/assets/js/custom.js') }}"></script>
