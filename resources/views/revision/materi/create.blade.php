        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
            <div class="widget-content-area br-4">
                <div class="widget-one">
                    ...
                    <form action="{{ route('user.kelas.materi.store.new', $id) }}" method="post">
                        @csrf
                        <div class="form-row mb-4">
                            ...
                            <div class="form-group col-md-12">
                                <label for="keterangan">Log <span class="required">*</span></label>
                                <input name="keterangan" type="text" class="form-control" placeholder="Menambahkan materi...">
                                @error('keterangan')
                                    <div class="text-danger">
                                        {{ $message }}
                                    </div>
